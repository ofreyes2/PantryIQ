...
interface FormField {
  id: string;
  type: 'header' | 'input' | 'stepper' | 'display' | 'toggle' | 'buttons';
}
...
export function ManualFoodEntryForm({ onSave, onCancel }: ManualFoodEntryFormProps) {
  ...
  const formFields: FormField[] = [
    { id: 'back', type: 'header' },
    { id: 'title', type: 'header' },
    { id: 'foodName', type: 'input' },
    { id: 'brand', type: 'input' },
    { id: 'servingDesc', type: 'input' },
    { id: 'servings', type: 'stepper' },
    { id: 'calories', type: 'input' },
    { id: 'carbs', type: 'input' },
    { id: 'fiber', type: 'input' },
    { id: 'netCarbs', type: 'display' },
    { id: 'protein', type: 'input' },
    { id: 'fat', type: 'input' },
    { id: 'sugar', type: 'input' },
    { id: 'sodium', type: 'input' },
    { id: 'saveAsFavorite', type: 'toggle' },
    { id: 'buttons', type: 'buttons' },
  ];

  const renderField = useCallback(({ item }: { item: FormField }) => {
    ...
    switch (item.id) {
      case 'back':
        return (
          <Pressable
            onPress={onCancel}
            style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 16, paddingHorizontal: 20, paddingTop: 12 }}
          >
      ...
      case 'title':
        return (
          <Text style={{ fontFamily: 'PlayfairDisplay_700Bold', fontSize: 22, color: Colors.textPrimary, marginBottom: 20, paddingHorizontal: 20 }}>
            Enter Food Details
          </Text>
        );
  ...
  }, [foodName, brand, servingDesc, servings, calories, carbs, fiber, protein, fat, sugar, sodium, saveAsFavorite, errors, netCarbs, onCancel, onSave, carbsNum, fiberNum]);
