...
/**
 * Get seed entries with dates calculated dynamically
 * This ensures that seed data always uses today's and yesterday's dates
 * even when the app is used across midnight or days
 */
const getSeedEntries = (): FoodEntry[] => {
